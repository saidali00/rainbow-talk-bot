            ...
            <div className="mt-auto px-3 py-4 border-t border-sidebar-dark-hover">
              ...
              <div className="grid grid-cols-3 gap-2">
                <a
                  ...
                  className="flex flex-col items-center gap-1.5 p-2.5 rounded-xl bg-gradient-to-br from-purple-600/20 via-pink-500/20 to-yellow-500/20 hover:from-purple-600/30 hover:via-pink-500/30 hover:to-yellow-500/30 transition-all group"
                  aria-label="Instagram bhatakash07"
                >
                  <svg className="w-6 h-6 text-pink-400 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <rect x="2" y="2" width="20" height="20" rx="5" ry="5" />
                    <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" />
                    <line x1="17.5" y1="6.5" x2="17.51" y2="6.5" />
                  </svg>
                  <span className="text-[10px] font-medium truncate max-w-full text-pink-100">bhatakash07</span>
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center gap-1.5 p-2.5 rounded-xl bg-gradient-to-br from-yellow-400/20 to-yellow-600/20 hover:from-yellow-400/30 hover:to-yellow-600/30 transition-all group"
                  aria-label="Snapchat bhatakash071"
                >
                  <svg className="w-6 h-6 text-yellow-300 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <span className="text-[10px] font-medium truncate max-w-full text-yellow-100">bhatakash071</span>
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center gap-1.5 p-2.5 rounded-xl bg-gradient-to-br from-sky-500/20 to-blue-600/20 hover:from-sky-500/30 hover:to-blue-600/30 transition-all group"
                  aria-label="Telegram anonymousmrak"
                >
                  <svg className="w-6 h-6 text-sky-300 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/>
                  </svg>
                  <span className="text-[10px] font-medium truncate max-w-full text-sky-100">anonymousmrak</span>
                </a>
              </div>
            </div>
          </div>
