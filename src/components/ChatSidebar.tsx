        ...
        {view === "menu" && (
          <div className="flex-1 flex flex-col">
            ...
            <div className="mt-auto px-3 py-4 border-t border-sidebar-dark-hover">
              <h3 className="px-4 text-[10px] font-semibold uppercase tracking-wider opacity-50 mb-3">Contact Us</h3>
              <div className="space-y-2">
                <a
                  href="https://instagram.com/bhatakash07"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 px-4 py-2.5 rounded-xl bg-gradient-to-r from-purple-600/15 via-pink-500/15 to-yellow-500/15 hover:from-purple-600/25 hover:via-pink-500/25 hover:to-yellow-500/25 transition-all group border border-pink-500/10"
                  aria-label="Instagram bhatakash07"
                >
                  <svg className="w-5 h-5 text-pink-400 group-hover:scale-110 transition-transform shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <rect x="2" y="2" width="20" height="20" rx="5" ry="5" />
                    <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" />
                    <line x1="17.5" y1="6.5" x2="17.51" y2="6.5" />
                  </svg>
                  <span className="text-xs font-medium text-pink-100">Instagram</span>
                  <span className="text-[10px] text-pink-200/70 ml-auto">@bhatakash07</span>
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 px-4 py-2.5 rounded-xl bg-gradient-to-r from-yellow-400/15 to-yellow-600/15 hover:from-yellow-400/25 hover:to-yellow-600/25 transition-all group border border-yellow-500/10"
                  aria-label="Snapchat bhatakash071"
                >
                  <svg className="w-5 h-5 text-yellow-300 group-hover:scale-110 transition-transform shrink-0" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <span className="text-xs font-medium text-yellow-100">Snapchat</span>
                  <span className="text-[10px] text-yellow-200/70 ml-auto">@bhatakash071</span>
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 px-4 py-2.5 rounded-xl bg-gradient-to-r from-sky-500/15 to-blue-600/15 hover:from-sky-500/25 hover:to-blue-600/25 transition-all group border border-sky-500/10"
                  aria-label="Telegram anonymousmrak"
                >
                  <svg className="w-5 h-5 text-sky-300 group-hover:scale-110 transition-transform shrink-0" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/>
                  </svg>
                  <span className="text-xs font-medium text-sky-100">Telegram</span>
                  <span className="text-[10px] text-sky-200/70 ml-auto">@anonymousmrak</span>
                </a>
              </div>
            </div>
          </div>
